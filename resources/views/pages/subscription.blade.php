        ...
        <form id="subscriptionForm">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input meal-type" type="checkbox" value="1" id="breakfast">
                    <label class="form-check-label" for="breakfast">Breakfast</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input meal-type" type="checkbox" value="1" id="lunch">
                    <label class="form-check-label" for="lunch">Lunch</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input meal-type" type="checkbox" value="1" id="dinner">
            ...
            <div class="mb-3">
                ...
                <div class="row">
                    @foreach(['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'] as $day)
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input delivery-day" type="checkbox" value="1" id="{{ strtolower($day) }}">
